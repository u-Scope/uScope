...
do
	...
	do
		...
		sleep 20
		sudo python ${ebpf_file} ${dist_dir}/${fs}/ebpf/ebpf_${fs}_n${node_size}_t${type}_${datacow}_${datasum}_fileserver_${count}.txt 2>/dev/null &
		sleep 10
		sudo killall python
		wait
		...
		sleep 20
		sudo python ${ebpf_file} ${dist_dir}/${fs}/ebpf/ebpf_${fs}_n${node_size}_t${type}_${datacow}_${datasum}_webserver_${count}.txt 2>/dev/null &
		sleep 10
		sudo killall python
		wait
		...
		sleep 20
		sudo python ${ebpf_file} ${dist_dir}/${fs}/ebpf/ebpf_${fs}_n${node_size}_t${type}_${datacow}_${datasum}_varmail_${count}.txt 2>/dev/null &
		sleep 10
		sudo killall python
		wait
